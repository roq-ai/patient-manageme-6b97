...
import { useNurseFindFirst, useRoqClient } from 'lib/roq';
...
function NurseViewPage() {
  ...
  const { data, error, isLoading } = useNurseFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('nurse', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/nurses/edit/${id}`} passHref legacyBehavior>
                    <Button
