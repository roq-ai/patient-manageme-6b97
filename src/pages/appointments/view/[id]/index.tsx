...
function AppointmentViewPage() {
  ...
  const queryParams = useMemo<{ include: { patient: boolean; doctor: boolean; nurse: boolean; hospital: boolean } }>(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['patient', 'doctor', 'nurse', 'hospital'],
          id,
        },
        'appointment',
      ),
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('nurse', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Nurse"
                    text={
                      <Link as={NextLink} href={`/nurses/view/${data?.nurse?.id}`}>
