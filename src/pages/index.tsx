  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless administrative tasks management and secure patient records storage with Patient Management Application, your ultimate tool for efficient healthcare service."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1620050382792-434b5828873d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwYXRpZW50JTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTgxNjAzODN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@benjaminwedemeyer?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Benjamin Wedemeyer`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless administrative tasks management and secure patient records storage with Patient Management Application, your ultimate tool for efficient healthcare service.`}
            </Text>
            <Box
