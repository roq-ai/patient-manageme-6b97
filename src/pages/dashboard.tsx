...
import { useRoqPlatformUserProfiles, useNurseCount, usePatientCount, useDoctorCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      title: 'Nurses',
      result: nurseStat?.data,
      isLoading: nurseStat.isLoading,
